...
const Sessions = (() => {
  ...
  function _renderEditResult(p) {
    return `<div class="tr-card tr-edit"><div class="tr-header"><span class="tr-icon">✏️</span><span class="tr-path">${escapeHtml(p.path || "")}</span><span class="tr-meta">${p.occurrences || 1} change(s)</span></div></div>`;
  }
  ...
  function _renderTodoResult(p) {
    ...
    html += `<div class="tr-header"><span class="tr-icon">✅</span><span class="tr-action">${escapeHtml(p.action || "")}</span></div>`;
    if (todos.length) {
      html += `<div class="tr-list">`;
      todos.forEach(t => {
