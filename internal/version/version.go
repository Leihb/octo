...
//
//	go build -ldflags "-X github.com/Leihb/octo-agent/internal/version.Version=0.12.0 -X github.com/Leihb/octo-agent/internal/version.Commit=$(git rev-parse --short HEAD)" ./cmd/octo
package version
